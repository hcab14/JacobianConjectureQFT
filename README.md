...
| `scripts/search_vquad.py` | B3 remnant: v-quadratic class of (1,-1,-2) in the AM-containing box — only tame + AM stratum (genuine v² forces R≡1 ⇒ Jung–van der Kulk; r₂≠0 EMPTY); cheap deg_v=3 probe same pattern (see `docs/SEARCH_VQUAD.md`) | ~5 min (`--full` larger boxes) |
