...
| T5 | **Certified geometric monodromy** $=S_3$ (interval or exact braid tracking) | §4 Stokes; §6 anomaly | OPEN_QUESTIONS B6; certify `monodromy.py` / `wall_braid.py` trackers |
